...
ax6.plot(result_spherical_confinement.ts * 1e6, result_spherical_confinement.radius * 1e6, 
        label="Spherical Confinement", lw=2.5, color='#8c564b')
...
ax5.plot(result_leighton_gompertz.ts * 1e6, result_leighton_gompertz.radius * 1e6, 
        label="Leighton-Gompertz", lw=2.5, color='#9467bd')
...
ax4.plot(result_keller_miksis_gompertz.ts * 1e6, result_keller_miksis_gompertz.radius * 1e6, 
        label="Keller-Miksis-Gompertz", lw=2.5, color='#d62728')
...
ax2.plot(result_marmottant.ts * 1e6, result_marmottant.radius * 1e6, 
        label="Marmottant", lw=2.5, color='#1f77b4')
...
ax3.plot(result_gompertz.ts * 1e6, result_gompertz.radius * 1e6, 
        label="Marmottant-Gompertz", lw=2.5, color='#ff7f0e')
...
ax1.plot(result_rayleigh_plesset.ts * 1e6, result_rayleigh_plesset.radius * 1e6, 
        label="Rayleigh-Plesset", lw=2.5, color='#2ca02c')
