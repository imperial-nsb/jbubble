...
def plot_surface_tension_comparison(
    bubbles, labels=None, R_min=None, R_max=None, num_points=500
):
    """
    ...
    plt.title(
        "Surface Tension Comparison: Marmottant vs Marmottant-Gompertz", fontsize=14
    )
