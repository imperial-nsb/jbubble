...
def test_run_simulation_returns_result(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
    assert isinstance(result, SimulationResult)


def test_run_simulation_ts_shape(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
    assert result.ts.shape == (save_spec.num_samples,)


def test_run_simulation_array_shapes_consistent(km_eom, pulse, save_spec):
    result = run_simulation(km_eom, pulse, save_spec=save_spec)
...
def test_run_simulation_ts_in_physical_units(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
...
def test_run_simulation_radius_in_physical_units(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
...
def test_run_simulation_no_vessel_for_simple_models(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
...
def test_run_simulation_has_vessel_for_confinement(pulse, save_spec):
...
def test_compute_radius_metrics_has_expected_keys(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
...
def test_compute_radius_metrics_positive_values(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
    metrics = compute_radius_metrics(result)
...
def test_compute_radius_metrics_max_gte_min(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
    metrics = compute_radius_metrics(result)
...
def test_arrays_from_result_returns_numpy(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
...
def test_arrays_from_result_shapes(rp_eom, pulse, save_spec):
    result = run_simulation(rp_eom, pulse, save_spec=save_spec)
    arrays = arrays_from_result(result)
    n = save_spec.num_samples
